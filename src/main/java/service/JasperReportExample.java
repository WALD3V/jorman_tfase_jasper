...
public class JasperReportExample {
    ...
    public static void generarReporte(RolGeneral rolGeneral, String fileName) {
        try {
            ...
            // Crear datasources para las listas internas (suponiendo que getIngresos() y
            // getEgresos() devuelven List<DetalleRol>)
            ...
            JRBeanCollectionDataSource descuentosDataSource = new JRBeanCollectionDataSource(
                    rolGeneral.getDescuentos());
